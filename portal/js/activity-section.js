;(function () {
  ...
  function render(state) {
    ...
    addBtn.type = "button";
    addBtn.className = "entity-activity__addBtn";
  ...
  function renderFooter(state) {
    ...
    if (state.hasMore && !state.isFull) {
      ...
      btn.type = "button";
      btn.className = "entity-activity__showAllBtn";
  ...
  function renderLogItem(state, log) {
    ...
    if (isOwner) {
      ...
      editBtn.type = "button";
      editBtn.className = "activity-item__actionBtn";
      ...
      delBtn.type = "button";
      delBtn.className = "activity-item__actionBtn activity-item__actionBtn--danger";
  ...
  function beginInlineEdit(state, logId) {
    ...
    saveBtn.type = "button";
    saveBtn.className = "activity-item__actionBtn";
    ...
    cancelBtn.className = "activity-item__actionBtn";
